 ...
 * @author yhel001
 */
public final class Admin_Logs extends javax.swing.JFrame {

    Connection conn = null;
    ResultSet rs = null;
    PreparedStatement pst = null;
    JTextField id = new JTextField();
    JTextField person_user = new JTextField();
    ...
    private void initComponents() {
        ...
        webTable1_LOG_Table.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                webTable1_LOG_TableMouseEntered(evt);
            }
        });
        ...
        getContentPane().add(webButton1_dl_logs, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 370, -1, 30));
        ...
        setSize(new java.awt.Dimension(730, 445));
    ...
    private void webTable1_LOG_TableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_webTable1_LOG_TableMouseClicked
        ...
        String Table_Click_id = (webTable1_LOG_Table.getModel().getValueAt(row, 0).toString());
        String Table_Click_person = (webTable1_LOG_Table.getModel().getValueAt(row, 1).toString());
        String Table_Click_act = (webTable1_LOG_Table.getModel().getValueAt(row, 2).toString());
        String Table_Click_date = (webTable1_LOG_Table.getModel().getValueAt(row, 3).toString());
        id.setText(Table_Click_id);
        person_user.setText(Table_Click_person);
        activity.setText(Table_Click_act);
        date.setText(Table_Click_date);
    ...
    private void webButton1_dl_logsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_webButton1_dl_logsActionPerformed
        //Component capture[] = webTable1_LOG_Table.getComponents();
        //TableModel capture = webTable1_LOG_Table.getModel();
        String data = id.getText() + " " + person_user.getText() + " " + activity.getText() + " " + date.getText();
        try {
            File logs = new File("Logs.txt");
            FileWriter fw = new FileWriter(logs);
            fw.append(data + "\r\n");

            //fw.write(String.valueOf(capture));
            fw.close();
        } catch (IOException ex) {
            Logger.getLogger(Admin_Logs.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_webButton1_dl_logsActionPerformed

    private void webTable1_LOG_TableMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_webTable1_LOG_TableMouseEntered

    }//GEN-LAST:event_webTable1_LOG_TableMouseEntered
...
private void setIcon() {
    ...
    private void ViewLogs() {
        try {
            String sql = "select id as 'User ID', Personel_Users as 'Users', Activity as 'Activity', Date as 'Date and time of Activity' from logs order by id desc";
